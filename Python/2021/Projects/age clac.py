...
root.configure(bg="#00ffff")   #setting up background color
root.geometry("400x300")    #fixing the size of the window
root.iconbitmap("age.ico") # set Icon
new=Label(root,bg="#00ffff")  #declaring a label
new.grid(row=5,column=0,columnspan=5)
...
title_label=Label(root,text="AGE CALC",borderwidth=30,fg="#404042",bg="#fff")
title_label.config(font=("Arial Rounded MT Bold",50))
...
entry_date=Entry(root,width=50,borderwidth=8)
...
clear=Button(root,text="CLEAR",width=10,command=lambda:clean(entry_date,entry_month,entry_year),fg="#000",bg="#404042")
